                        ...
                        if ($lista_cesta == null || empty($lista_cesta)) {
                            ...
                            foreach ($lista_cesta as $producto) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="#" id="eliminar" class="btn btn-cesta" data-bs-id="<?php echo $_id; ?>" data-bs-toggle="modal" data-bs-target="#eliminaModal">Eliminar</a></td>
                                </tr>
                            <?php }
                        } ?>
                        <tr>
    ...
    <div class="modal fade" id="eliminaModal" tabindex="-1" aria-labelledby="eliminaModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">Eliminara el producto de la cesta</div>
